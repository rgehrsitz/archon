...
func (g *gitRepoStub) GetRemoteURL(remote string) (string, errors.Envelope) {
	return "", errors.Envelope{}
}
func (g *gitRepoStub) SetRemoteURL(remote, url string) errors.Envelope { return errors.Envelope{} }
func (g *gitRepoStub) Status(ctx context.Context) (*git.Status, errors.Envelope) {
	return &git.Status{}, errors.Envelope{}
}
func (g *gitRepoStub) GetCurrentBranch(ctx context.Context) (string, errors.Envelope) {
	return "main", errors.Envelope{}
}
func (g *gitRepoStub) GetCommitHistory(ctx context.Context, limit int) ([]git.Commit, errors.Envelope) {
	return nil, errors.Envelope{}
}
func (g *gitRepoStub) Clone(ctx context.Context, url, path string) errors.Envelope {
	return errors.Envelope{}
}
func (g *gitRepoStub) Fetch(ctx context.Context, remote string) errors.Envelope {
	return errors.Envelope{}
}
func (g *gitRepoStub) Pull(ctx context.Context, remote, branch string) errors.Envelope {
	return errors.Envelope{}
}
func (g *gitRepoStub) Push(ctx context.Context, remote, branch string) errors.Envelope {
	return errors.Envelope{}
}
func (g *gitRepoStub) Add(ctx context.Context, paths []string) errors.Envelope {
	return errors.Envelope{}
}
...
func (g *gitRepoStub) CreateTag(ctx context.Context, name, message string) errors.Envelope {
	return errors.Envelope{}
}
func (g *gitRepoStub) ListTags(ctx context.Context) ([]git.Tag, errors.Envelope) {
	return nil, errors.Envelope{}
}
func (g *gitRepoStub) Checkout(ctx context.Context, ref string) errors.Envelope {
	return errors.Envelope{}
}
func (g *gitRepoStub) InitLFS(ctx context.Context) errors.Envelope { return errors.Envelope{} }
func (g *gitRepoStub) IsLFSEnabled(ctx context.Context) (bool, errors.Envelope) {
	return false, errors.Envelope{}
}
func (g *gitRepoStub) TrackLFSPattern(ctx context.Context, pattern string) errors.Envelope {
	return errors.Envelope{}
}
func (g *gitRepoStub) GetDiff(ctx context.Context, from, to string) (*git.Diff, errors.Envelope) {
	return &git.Diff{}, errors.Envelope{}
}
